  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
          stream:
              FirebaseFirestore.instance.collection('OrderData').snapshots(),
          builder: (context, order) {
            ...
            var quantityOfBread =
                dailyOrder.map((e) => e['orderedKilo']).toList();

            var priceOfBread = dailyOrder.map((e) => e['totalAmount']).toList();
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'Daily KG : $totOrderedKg kg',
                                  style: dailyIncomeStyle,
                                ),
                                Text(
                                  'Total Income: $totPriceOrder',
                                  style: dailyIncomeStyle,
                                ),
                              ],
                            ),
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                              DateFormat.E()
                                                                  .add_jm()
                                                                  .format(
                                                                    DateTime.parse(dailyOrder[index]
                                                                            [
                                                                            'date']
                                                                        .toString()),
                                                                  ),
